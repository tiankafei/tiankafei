...
public class CodeGenerator {
     ...
     */
    public void init() {
        this.projectMainPackage = projectPackagePath.replace("/", ".");
        ...
        this.commonIdsParam = this.commonParentPackage + ".param.IdsParam";
    ...
    public void generator(String directory) {
        ...
        pc.setParent(projectMainPackage);
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("pageQueryParamPath", queryParamPackage + StringPool.DOT + pascalTableName + "PageQueryParam");
                // 查询参数共公包路径
                map.put("queryParamCommonPath", superQueryParam);
                // 查询参数共公包路径
                map.put("idParamPath", commonIdParam);
                map.put("idsParamPath", commonIdsParam);
                // 响应结果包路径
                String queryVoPackage = projectMainPackage + StringPool.DOT + pc.getModuleName() + ".vo";
            ...
            focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    ...
                    if (mapperXmlFlag) {
                        ...
                        return projectPath + "/src/main/java/" + projectPackagePath + "/" + pc.getModuleName() + "/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                    }
    ...
    private String getCurrentProjectRootFilePath(Object object, String directory) {
        ...
        filePath.append(path[startIndex]);
        for (int index = startIndex + 1, length = path.length; index < length - 2; index++) {
            filePath.append(File.separator).append(path[index]);
        }
        return filePath.toString();
//        return "E:\\gits\\tiankafei-microservice-demo\\tiankafei-service";
    }
