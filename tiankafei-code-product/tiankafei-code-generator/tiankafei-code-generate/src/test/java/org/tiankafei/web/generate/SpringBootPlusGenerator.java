...
public class SpringBootPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        codeGenerator
                ...
                .setDriverUrl("jdbc:mysql://software:3306/master?useUnicode=true&characterEncoding=UTF-8&useSSL=false");

        // 包信息
        codeGenerator
                .setProjectPackagePath("com/tiankafei")
                .setParentPackage("com.tiankafei");

        // 组件作者等配置
        codeGenerator
                .setModuleName("reportdesign")
                .setAuthor("tiankafei")
