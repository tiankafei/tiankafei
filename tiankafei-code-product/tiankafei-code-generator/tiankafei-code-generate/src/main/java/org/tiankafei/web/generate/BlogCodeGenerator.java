...
public class BlogCodeGenerator extends BaseCodeGenerator {
    ...
    protected CodeProperties initCodeProperties() {
        ...
        codeProperties.setUrl("jdbc:mysql://localhost:3306/db-blog?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true");
