...
@Api(value = "规则设计表达式用户新增的对象 API", tags = {"规则设计表达式用户新增的对象"})
public class RuleDesignController extends BaseController {
     ...
     */
    @PostMapping("/check")
    @ApiOperation(value = "校验 规则设计表达式用户新增的对象 对象是否存在")
     ...
     */
    @PostMapping
    @ApiOperation(value = "添加 规则设计表达式用户新增的对象")
     ...
     */
    @PostMapping("/batch")
    @ApiOperation(value = "批量添加 规则设计表达式用户新增的对象")
     ...
     */
    @DeleteMapping("/{id}")
    @ApiOperation(value = "删除 规则设计表达式用户新增的对象")
     ...
     */
    @DeleteMapping("/batch")
    @ApiOperation(value = "批量删除 规则设计表达式用户新增的对象")
    ...
    @ApiOperation(value = "条件删除 规则设计表达式用户新增的对象")
     ...
     */
    @PatchMapping
    @ApiOperation(value = "修改 规则设计表达式用户新增的对象")
     ...
     */
    @GetMapping("/{id}")
    @ApiOperation(value = "根据ID获取 规则设计表达式用户新增的对象 对象")
     ...
     */
    @GetMapping
    @ApiOperation(value = "获取 规则设计表达式用户新增的对象 对象全部列表")
     ...
     */
    @PostMapping("/list")
    @ApiOperation(value = "获取 规则设计表达式用户新增的对象 对象列表")
    ...
    @ApiOperation(value = "获取 规则设计表达式用户新增的对象 分页对象列表")
     ...
     */
    @PostMapping("/count")
    @ApiOperation(value = "求 规则设计表达式用户新增的对象 对象的记录数")
