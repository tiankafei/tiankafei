...
public interface SysUserInfoFeign {
     ...
     * 校验 用户名 是否已经存在
     */
    @GetMapping("/sysUserInfo/checkUsername/{username}")
     ...
     * 校验  邮箱 是否已经存在
     */
    @GetMapping("/sysUserInfo/checkEmail/{email}")
     ...
     * 校验 手机号码 是否已经存在
     */
    @GetMapping("/sysUserInfo/checkTelephone/{telephone}")
     ...
     * 删除 用户基本信息表 对象
     */
    @DeleteMapping("/sysUserInfo/delete")
     ...
     * 获取 用户基本信息表 对象详情
     */
    @GetMapping("/sysUserInfo/info/{id}")
     ...
     * 获取 用户基本信息表 分页列表
     */
    @PostMapping("/sysUserInfo/pageList")
