...
public class AttributesInfoController extends BaseController {
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:check")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:add")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:batchAdd")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:delete")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:batchDelete")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:conditionDelete")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:update")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:info")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:AllList")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:list")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:pageList")
    ...
    @PreAuthorize(hasPermi = "sys:attributes:info:count")
