...
@Api(value = "系统功能菜单 API", tags = "系统功能菜单 功能维护")
public class SysFeatureInfoController extends BaseController {
     ...
     */
    @PostMapping("/check")
    @ApiOperation(value = "校验 系统功能菜单 是否已经存在", notes = "校验 系统功能菜单 是否已经存在")
     ...
     */
    @PostMapping("/add")
    @ApiOperation(value = "添加 系统功能菜单 对象", notes = "添加 系统功能菜单")
     ...
     */
    @PostMapping("/update")
    @ApiOperation(value = "修改 系统功能菜单 对象", notes = "修改 系统功能菜单")
     ...
     */
    @PostMapping("/delete")
    @ApiOperation(value = "删除 系统功能菜单 对象", notes = "删除 系统功能菜单")
     ...
     */
    @GetMapping("/info/{id}")
    @ApiOperation(value = "获取 系统功能菜单 对象详情", notes = "获取 系统功能菜单 对象详情")
    ...
    @ApiOperation(value = "获取 系统功能菜单 分页列表", notes = "获取 系统功能菜单 分页列表")
     ...
     */
    @PostMapping("/list")
    @ApiOperation(value = "获取 系统功能菜单 列表", notes = "获取 系统功能菜单 列表")
     ...
     */
    @PostMapping("/count")
    @ApiOperation(value = "计算 系统功能菜单 总记录数", notes = "计算 系统功能菜单 总记录数")
