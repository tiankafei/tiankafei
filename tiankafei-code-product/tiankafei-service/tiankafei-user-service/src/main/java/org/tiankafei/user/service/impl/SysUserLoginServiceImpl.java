...
public class SysUserLoginServiceImpl extends BaseServiceImpl<SysUserLoginMapper, SysUserLoginEntity> implements SysUserLoginService {
    ...
    public Object addSysUserLogin(SysUserLoginQueryVo sysUserLoginQueryVo) throws Exception {
        // 新增时校验用户信息是否存在
        queryUserAndCheckExistsClient.checkAddSysUserExists(LoginEnums.USER_NAME.getCode(), sysUserLoginQueryVo.getUsername());
        queryUserAndCheckExistsClient.checkAddSysUserExists(LoginEnums.EMAIL.getCode(), sysUserLoginQueryVo.getEmail());
        queryUserAndCheckExistsClient.checkAddSysUserExists(LoginEnums.PHONE.getCode(), sysUserLoginQueryVo.getTelephone());
    ...
    public boolean updateSysUserLogin(SysUserLoginQueryVo sysUserLoginQueryVo) throws Exception {
        ...
        // 修改时，校验用户信息是否存在
        queryUserAndCheckExistsClient.checkUpdateSysUserExists(LoginEnums.USER_NAME.getCode(), sysUserLoginQueryVo.getUsername(), oldUserEntity.getUsername());
        queryUserAndCheckExistsClient.checkUpdateSysUserExists(LoginEnums.EMAIL.getCode(), sysUserLoginQueryVo.getEmail(), oldUserEntity.getEmail());
        queryUserAndCheckExistsClient.checkUpdateSysUserExists(LoginEnums.PHONE.getCode(), sysUserLoginQueryVo.getTelephone(), oldUserEntity.getTelephone());
