...
public class SysMenuInfoController extends BaseController {
    ...
    public ApiResult<Boolean> checkSysMenuInfoExists(@Valid @RequestBody SysMenuInfoQueryParam sysMenuInfoQueryParam) throws Exception {
        Boolean flag = sysMenuInfoService.checkSysMenuInfoExists(sysMenuInfoQueryParam);
    ...
    public ApiResult<String> addSysMenuInfo(@Valid @RequestBody SysMenuInfoQueryVo sysMenuInfoQueryVo) throws Exception {
        Object id = sysMenuInfoService.addSysMenuInfo(sysMenuInfoQueryVo);
    ...
    public ApiResult<Boolean> updateSysMenuInfo(@Valid @RequestBody SysMenuInfoQueryVo sysMenuInfoQueryVo) throws Exception {
        boolean flag = sysMenuInfoService.updateSysMenuInfo(sysMenuInfoQueryVo);
        return ApiResult.ok(flag);
    }
    ...
    public ApiResult<Boolean> deleteSysMenuInfo(@Valid @RequestBody IdsParam idsParam) throws Exception {
        boolean flag = sysMenuInfoService.deleteSysMenuInfo(idsParam.getIds());
        return ApiResult.ok(flag);
    }
    ...
    public ApiResult<Integer> countSysMenuInfo(@Valid @RequestBody SysMenuInfoQueryParam sysMenuInfoQueryParam) throws Exception {
        int count = sysMenuInfoService.countSysMenuInfo(sysMenuInfoQueryParam);
