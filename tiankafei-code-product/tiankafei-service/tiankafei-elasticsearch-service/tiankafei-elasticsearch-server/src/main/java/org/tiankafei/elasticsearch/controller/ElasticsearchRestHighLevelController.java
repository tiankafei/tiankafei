...
@Api(value = "Elasticsearch-RestHighLevel操作 API", tags = {"Elasticsearch-RestHighLevel操作"})
public class ElasticsearchRestHighLevelController {

    @Autowired
    private IElasticsearchService elasticsearchRestHighLevelServiceImpl;
    ...
    public ApiResult<Boolean> checkIndexNameExists(@PathVariable String indexName) throws Exception {
        return ApiResult.ok(elasticsearchRestHighLevelServiceImpl.checkIndexNameExists(indexName));
    }
    ...
    public ApiResult<Boolean> insertData(@PathVariable String indexName) throws Exception {
        return ApiResult.ok(elasticsearchRestHighLevelServiceImpl.insertData(indexName));
    }
