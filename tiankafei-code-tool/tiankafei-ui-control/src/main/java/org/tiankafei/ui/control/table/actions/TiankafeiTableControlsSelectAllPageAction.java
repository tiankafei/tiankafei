 ...
 * @author tiankafei1
 */
public class TiankafeiTableControlsSelectAllPageAction extends AbstractTiankafeiActionListener {
     ...
     */
    public TiankafeiTableControlsSelectAllPageAction(List<TiankafeiTable> tiankafeiTableList) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
            tableDataModel.setValueAt(true, rowIndex, tableChooseColumnIndex);
        }
