 ...
 * @author tiankafei1
 */
public class TiankafeiAddConditionAction extends AbstractTiankafeiActionListener {
     ...
     * @param width                      控件宽度
     */
    public TiankafeiAddConditionAction(TiankafeiConditionControls tiankafeiConditionControls, TkfPanel tkfPanel, int width) {
    ...
    public void actionPerformed(ActionEvent e) {
        tiankafeiConditionControls.initAddConditionPanel(tkfPanel, width, null);
    }
