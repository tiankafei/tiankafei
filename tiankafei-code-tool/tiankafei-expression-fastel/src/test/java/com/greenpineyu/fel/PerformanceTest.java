...
//				String s = "hello world";
    ...
    private static void fel(String exp, Map<String, Object> vars, int times) throws Exception {
        FelContext ctx = new MapContext(vars);
        ctx = new ArrayCtxImpl(vars);
        fel(exp, ctx, times);
    }

    private static long fel(String exp, FelContext ctx, int times) throws Exception {
