 ...
 * @author tiankafei
 */
public class VerifyIdCardOperation extends BaseOneOperation {
    ...
    private VerifyIdCardOperation() {
    }

    private static class InternalClass {
        private final static BaseOneOperation INSTANCE = new VerifyIdCardOperation();
    }
