 ...
 * @author tiankafei
 */
public abstract class BaseAbstCompiler implements FelCompiler {
    /**
     * 用户编译的classpath
     */
    ...
    static {
        ...
        loader = new FileClassLoader(BaseAbstCompiler.class.getClassLoader(),
                CLASS_DIR);
        createClassDir();
    }
    ...
    private static String getClassPath() {
         ...
         */
        Class<?> cls = BaseAbstCompiler.class;
        ...
        if (isJar) {
            ...
            if (lib != null) {
                ...
                String webInf = lib.getParent();
                String classDir = webInf + File.separator + "classes";
            ...
            if (index != -1) {
                ...
                cpSet.add(classDir);
                File classDirFile = new File(classDir);
                File webInf = classDirFile.getParentFile();
                String libDir = webInf + File.separator + "lib";
