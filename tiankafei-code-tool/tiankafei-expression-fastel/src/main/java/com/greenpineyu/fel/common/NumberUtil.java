...
public class NumberUtil {
     ...
     */
    public static int toInteger(Object val) throws IllegalArgumentException {
        if (val == null) {
     ...
     * @throws IllegalArgumentException
     */
    public static long toLong(Object val) throws IllegalArgumentException {
        if (val == null) {
     ...
     * @throws IllegalArgumentException
     */
    public static BigInteger toBigInteger(Object val) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException
     */
    public static BigDecimal toBigDecimal(Object val) throws IllegalArgumentException {
    ...
    public static Number narrowBigInteger(Object lhs, Object rhs, BigInteger bigi) {
        boolean flag = !(lhs instanceof BigInteger || rhs instanceof BigInteger)
                && bigi.compareTo(BIGI_LONG_MAX_VALUE) <= 0
                && bigi.compareTo(BIGI_LONG_MIN_VALUE) >= 0;
        if (flag) {
            long l = bigi.longValue();
            boolean flag1 = !(lhs instanceof Long || rhs instanceof Long)
                    && l <= Integer.MAX_VALUE
                    && l >= Integer.MIN_VALUE;
            if (flag1) {
     ...
     * @return
     */
    public static Object calArray(Object obj) throws Exception {
        ...
        if (!ArrayUtils.isEmpty((Object[]) obj)) {
            for (int i = 0; i < ((Object[]) obj).length; i++) {
                result = OperationFactory.getBaseOperation(FunctionConstants.ADD).evl(result, ((Object[]) obj)[i]);
            }
        }
        return result;
    }
