...
public class FelParser extends org.antlr.runtime.Parser {
    ...
    public final FelParser.parExpression_return parExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:21:9: '(' ! expressionList ')' !
            {
                ...
                char_literal2 = (Token) match(input, 35, FOLLOW_35_in_parExpression82);
                if (state.failed) {
                    return retval;
                }
                ...
                char_literal4 = (Token) match(input, 36, FOLLOW_36_in_parExpression87);
                if (state.failed) {
                    return retval;
                }
            ...
            // E:\\workspace\\Fel\\Fel.g:25:9: ( conditionalExpression )? ( ',' ! ( conditionalExpression )? )*
            {
                ...
                do {
                    ...
                    switch (alt3) {
                        ...
                        {
                            char_literal6 = (Token) match(input, 37, FOLLOW_37_in_expressionList114);
                            if (state.failed) {
                                return retval;
                            }
    ...
    public final FelParser.conditionalExpression_return conditionalExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:30:9: conditionalOrExpression ( Ques ^ conditionalExpression Colon ! conditionalExpression )?
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, conditionalOrExpression8.getTree());
                }
                ...
                switch (alt4) {
                    ...
                    {
                        Ques9 = (Token) match(input, Ques, FOLLOW_Ques_in_conditionalExpression153);
                        if (state.failed) {
                            return retval;
                        }
                        if (state.backtracking == 0) {
                        ...
                        if (state.backtracking == 0) {
                            adaptor.addChild(root_0, conditionalExpression10.getTree());
                        }

                        Colon11 = (Token) match(input, Colon, FOLLOW_Colon_in_conditionalExpression158);
                        if (state.failed) {
                            return retval;
                        }
                        ...
                        if (state.backtracking == 0) {
                            adaptor.addChild(root_0, conditionalExpression12.getTree());
                        }
    ...
    public final FelParser.conditionalOrExpression_return conditionalOrExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:33:4: conditionalAndExpression ( Or ^ conditionalAndExpression )*
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, conditionalAndExpression13.getTree());
                }
                ...
                do {
                    ...
                    switch (alt5) {
                        ...
                        {
                            Or14 = (Token) match(input, Or, FOLLOW_Or_in_conditionalOrExpression180);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, conditionalAndExpression15.getTree());
                            }
    ...
    public final FelParser.conditionalAndExpression_return conditionalAndExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:37:4: equalityExpression ( And ^ equalityExpression )*
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, equalityExpression16.getTree());
                }
                ...
                do {
                    ...
                    switch (alt6) {
                        ...
                        {
                            And17 = (Token) match(input, And, FOLLOW_And_in_conditionalAndExpression200);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, equalityExpression18.getTree());
                            }
    ...
    public final FelParser.equalityExpression_return equalityExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:41:9: relationalExpression ( Equals ^ relationalExpression )*
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, relationalExpression19.getTree());
                }
                ...
                do {
                    ...
                    switch (alt7) {
                        ...
                        {
                            Equals20 = (Token) match(input, Equals, FOLLOW_Equals_in_equalityExpression225);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, relationalExpression21.getTree());
                            }
    ...
    public final FelParser.relationalExpression_return relationalExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:45:9: additiveExpression ( Relational ^ additiveExpression )*
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, additiveExpression22.getTree());
                }
                ...
                do {
                    ...
                    switch (alt8) {
                        ...
                        {
                            Relational23 = (Token) match(input, Relational, FOLLOW_Relational_in_relationalExpression254);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, additiveExpression24.getTree());
                            }
    ...
    public final FelParser.additiveExpression_return additiveExpression() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:49:9: multiplicativeExpression ( Additive ^ multiplicativeExpression )*
            {
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, multiplicativeExpression25.getTree());
                }
                ...
                do {
                    ...
                    switch (alt9) {
                        ...
                        {
                            Additive26 = (Token) match(input, Additive, FOLLOW_Additive_in_additiveExpression282);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, multiplicativeExpression27.getTree());
                            }
            ...
            // E:\\workspace\\Fel\\Fel.g:53:9: unaryExpression ( Multiplicative ^ unaryExpression )*
            {
                ...
                do {
                    ...
                    switch (alt10) {
                        ...
                        {
                            Multiplicative29 = (Token) match(input, Multiplicative, FOLLOW_Multiplicative_in_multiplicativeExpression311);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
        ...
        try {
            ...
            switch (alt11) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:57:9: Additive ^ unaryExpression
                {
                    ...
                    Additive31 = (Token) match(input, Additive, FOLLOW_Additive_in_unaryExpression336);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
        ...
        try {
            ...
            switch (alt13) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:62:8: Not ^ unaryExpressionNotPlusMinus
                {
                    ...
                    Not34 = (Token) match(input, Not, FOLLOW_Not_in_unaryExpressionNotPlusMinus358);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:64:9: array ( Dot ^ parDot )*
                {
                    ...
                    do {
                        ...
                        switch (alt12) {
                            ...
                            {
                                Dot37 = (Token) match(input, Dot, FOLLOW_Dot_in_unaryExpressionNotPlusMinus378);
                                if (state.failed) {
                                    return retval;
                                }
                                if (state.backtracking == 0) {
                                ...
                                if (state.backtracking == 0) {
                                    adaptor.addChild(root_0, parDot38.getTree());
                                }
            ...
            // E:\\workspace\\Fel\\Fel.g:67:6: primary ( Bracket ^ conditionalExpression ']' !)*
            {
                ...
                do {
                    ...
                    switch (alt14) {
                        ...
                        {
                            Bracket40 = (Token) match(input, Bracket, FOLLOW_Bracket_in_array405);
                            if (state.failed) {
                                return retval;
                            }
                            if (state.backtracking == 0) {
                            ...
                            if (state.backtracking == 0) {
                                adaptor.addChild(root_0, conditionalExpression41.getTree());
                            }

                            char_literal42 = (Token) match(input, 38, FOLLOW_38_in_array410);
                            if (state.failed) {
                                return retval;
                            }
        ...
        try {
            ...
            switch (alt16) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:70:9: parExpression
                {
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, parExpression43.getTree());
                    }
                    ...
                    // E:\\workspace\\Fel\\Fel.g:71:9: parDot ( Dot ^ parDot )*
                {
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, parDot44.getTree());
                    }
                    ...
                    do {
                        ...
                        switch (alt15) {
                            ...
                            {
                                Dot45 = (Token) match(input, Dot, FOLLOW_Dot_in_primary457);
                                if (state.failed) {
                                    return retval;
                                }
                                if (state.backtracking == 0) {
                                ...
                                if (state.backtracking == 0) {
                                    adaptor.addChild(root_0, parDot46.getTree());
                                }
        ...
        try {
            ...
            switch (alt17) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:83:7: identifierOrFun
                {
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, identifierOrFun48.getTree());
                    }
                    ...
                    // E:\\workspace\\Fel\\Fel.g:84:7: StringLiteral
                {
                    ...
                    StringLiteral49 = (Token) match(input, StringLiteral, FOLLOW_StringLiteral_in_parDot516);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:85:7: CharacterLiteral
                {
                    ...
                    CharacterLiteral50 = (Token) match(input, CharacterLiteral, FOLLOW_CharacterLiteral_in_parDot524);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
        ...
        try {
            ...
            switch (alt18) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:89:8: Identifier
                {
                    ...
                    Identifier51 = (Token) match(input, Identifier, FOLLOW_Identifier_in_identifierOrFun549);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:90:9: Identifier ^ arguments
                {
                    ...
                    Identifier52 = (Token) match(input, Identifier, FOLLOW_Identifier_in_identifierOrFun564);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, arguments53.getTree());
                    }
    ...
    public final FelParser.arguments_return arguments() throws RecognitionException {
        ...
        try {
            ...
            // E:\\workspace\\Fel\\Fel.g:99:9: '(' ! ( expressionList )? ')' !
            {
                ...
                char_literal54 = (Token) match(input, 35, FOLLOW_35_in_arguments602);
                if (state.failed) {
                    return retval;
                }
                ...
                switch (alt19) {
                        ...
                        // E:\\workspace\\Fel\\Fel.g:99:14: expressionList
                    {
                        ...
                        if (state.backtracking == 0) {
                            adaptor.addChild(root_0, expressionList55.getTree());
                        }
                ...
                char_literal56 = (Token) match(input, 36, FOLLOW_36_in_arguments608);
                if (state.failed) {
                    return retval;
                }
        ...
        try {
            ...
            switch (alt20) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:136:9: integerLiteral
                {
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, integerLiteral57.getTree());
                    }
                    ...
                    // E:\\workspace\\Fel\\Fel.g:137:9: FloatingPointLiteral
                {
                    ...
                    FloatingPointLiteral58 = (Token) match(input, FloatingPointLiteral, FOLLOW_FloatingPointLiteral_in_literal657);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:138:9: CharacterLiteral
                {
                    ...
                    CharacterLiteral59 = (Token) match(input, CharacterLiteral, FOLLOW_CharacterLiteral_in_literal667);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:139:9: StringLiteral
                {
                    ...
                    StringLiteral60 = (Token) match(input, StringLiteral, FOLLOW_StringLiteral_in_literal677);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                    ...
                    // E:\\workspace\\Fel\\Fel.g:140:9: BooleanLiteral
                {
                    ...
                    BooleanLiteral61 = (Token) match(input, BooleanLiteral, FOLLOW_BooleanLiteral_in_literal687);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
    ...
    public final void synpred16_Fel_fragment() throws RecognitionException {
        ...
        // E:\\workspace\\Fel\\Fel.g:71:17: Dot parDot
        {
            match(input, Dot, FOLLOW_Dot_in_synpred16_Fel457);
            if (state.failed) {
                return;
            }
            ...
            do {
                ...
                switch (alt22) {
                    case 1:
                        // E:\\workspace\\Fel\\Fel.g:71:17: Dot parDot
                    {
                        match(input, Dot, FOLLOW_Dot_in_synpred17_Fel457);
                        if (state.failed) {
                            return;
                        }
