 ...
 * @author tiankafei
 */
public class GreaterThenEqualsOperation extends LessThenOperation {

    private GreaterThenEqualsOperation() {
    }

    private static class InternalClass {
        private final static BaseTwoOperation INSTANCE = new GreaterThenEqualsOperation();
    }
