 ...
 * @author tiankafei
 */
public class VerifyCreditCodeOperation extends BaseOneOperation {
    ...
    private VerifyCreditCodeOperation() {
    }

    private static class InternalClass {
        private final static BaseOneOperation INSTANCE = new VerifyCreditCodeOperation();
    }
