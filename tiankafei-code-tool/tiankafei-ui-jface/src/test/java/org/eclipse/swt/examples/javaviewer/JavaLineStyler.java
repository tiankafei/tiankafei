...
class JavaLineStyler implements LineStyleListener {
    ...
    void initializeColors() {
        colors = new Color[]{
                new Color(new Display(), new RGB(0, 0, 0)),        // black
                new Color(new Display(), new RGB(255, 0, 0)),    // red
                new Color(new Display(), new RGB(0, 255, 0)),    // green
                new Color(new Display(), new RGB(0, 0, 255))    // blue
        };
