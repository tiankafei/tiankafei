...
public class AviatorNilUnitTest {
    ...
    public void testCompare() {
        ...
        assertEquals(1, BaseAviatorNumber.valueOf(1).compare(AviatorNil.NIL, env));
        assertEquals(-1, AviatorNil.NIL.compare(BaseAviatorNumber.valueOf(1), env));
        assertEquals(1, BaseAviatorNumber.valueOf(-1000).compare(AviatorNil.NIL, env));
        assertEquals(-1, AviatorNil.NIL.compare(BaseAviatorNumber.valueOf(-1000), env));
