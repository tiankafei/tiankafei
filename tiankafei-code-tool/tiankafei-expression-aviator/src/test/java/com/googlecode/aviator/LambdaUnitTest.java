...
public class LambdaUnitTest {
    ...
    public void testSimpleLambda() {
        assertEquals(AviatorEvaluator.execute("lambda(a) -> a end(3)"), 3);
        assertEquals(AviatorEvaluator.execute("(lambda(a) -> a end)(3)"), 3);
        assertEquals(AviatorEvaluator.execute("(lambda(a,b) -> a+b end)(3,4)"), 7);
    }

    @Test(expected = AssertionError.class)
    public void testSimpleLambdaWithEnv() {
        assertEquals(AviatorEvaluator.getInstance().exec("lambda(a) -> a end(x)", 3), 3);
        assertEquals(AviatorEvaluator.getInstance().exec("(lambda(a) -> a end)(x)", 3), 3);
        assertEquals(AviatorEvaluator.getInstance().exec("(lambda(a,b) -> a+b end)(x,y)", 3, 4), 7);
    }
