...
public class AviatorNumberUnitTest {
    ...
    public void testCompareWithNumber() {
        BaseAviatorNumber a = BaseAviatorNumber.valueOf(1000);
        BaseAviatorNumber b = BaseAviatorNumber.valueOf(2000);
        assertTrue(a.compare(b, null) < 0);
        assertTrue(b.compare(a, null) > 0);

        BaseAviatorNumber c = BaseAviatorNumber.valueOf(3.2f);
        BaseAviatorNumber d = BaseAviatorNumber.valueOf(-0.3d);
        assertTrue(c.compare(d, null) > 0);
        assertTrue(d.compare(c, null) < 0);

        a = BaseAviatorNumber.valueOf(1000);
        b = BaseAviatorNumber.valueOf(1000);
    ...
    BaseAviatorNumber a = BaseAviatorNumber.valueOf(3.3f);
    BaseAviatorNumber b = BaseAviatorNumber.valueOf(3);
    BaseAviatorNumber c = BaseAviatorNumber.valueOf(1000);
    BaseAviatorNumber d = BaseAviatorNumber.valueOf(4.3d);
    BaseAviatorNumber e = BaseAviatorNumber.valueOf(new BigInteger(String.valueOf(Long.MAX_VALUE) + "1"));
    BaseAviatorNumber f =
            BaseAviatorNumber.valueOf(new BigDecimal(String.valueOf(Long.MAX_VALUE) + "1.1001"));
    ...
    private void reset() {
        this.a = BaseAviatorNumber.valueOf(3.3f);
        this.b = BaseAviatorNumber.valueOf(3);
        this.c = BaseAviatorNumber.valueOf(1000);
        this.d = BaseAviatorNumber.valueOf(4.3d);
        this.e = BaseAviatorNumber.valueOf(new BigInteger(String.valueOf(Long.MAX_VALUE) + "1"));
        this.f = BaseAviatorNumber.valueOf(new BigDecimal(String.valueOf(Long.MAX_VALUE) + "1.1001"));
    }


    @Test(expected = ExpressionRuntimeException.class)
    public void testNot() {
        BaseAviatorNumber.valueOf(3).not(null);
    }


    @Test
    public void testNeg() {
        BaseAviatorNumber n = BaseAviatorNumber.valueOf(3.3);
        assertEquals(-3.3, n.neg(null).getValue(null));

        n = BaseAviatorNumber.valueOf(3);
