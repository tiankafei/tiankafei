...
public class MathAbsFunctionUnitTest extends BaseMathFunctionUnitTestForOneArgument {
    ...
    public void testCall() {
        ...
        assertEquals(3, this.function.call(env, BaseAviatorNumber.valueOf(-3)).getValue(null));
        assertEquals(3.9, this.function.call(env, BaseAviatorNumber.valueOf(-3.9)).getValue(null));
        assertEquals(400, this.function.call(env, BaseAviatorNumber.valueOf(400)).getValue(null));
        assertEquals(new BigInteger("300000000000000000000000000000000"),
                this.function
                        .call(env, BaseAviatorNumber.valueOf(new BigInteger("-300000000000000000000000000000000")))
                        .getValue(null));
