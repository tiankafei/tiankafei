...
public class AviatorJavaTypeUnitTest {
    ...
    public void doArthOpJavaTypeNumber(OperatorType operatorType) {
        ...
        BaseAviatorNumber n1 = BaseAviatorNumber.valueOf(3);
        BaseAviatorNumber n2 = BaseAviatorNumber.valueOf(3.3f);
    ...
    public void addJavaBooleanWithNumber() {
        ...
        a.add(BaseAviatorNumber.valueOf(3), createEnvWith(null, null));
    }
    ...
    public void subJavaBooleanWithNumber() {
        AviatorJavaType a = new AviatorJavaType("true");
        a.sub(BaseAviatorNumber.valueOf(3), createEnvWith(null, null));
    }
    ...
    public void multJavaBooleanWithNumber() {
        AviatorJavaType a = new AviatorJavaType("true");
        a.mult(BaseAviatorNumber.valueOf(3), createEnvWith(null, null));
    }
    ...
    public void divJavaBooleanWithNumber() {
        AviatorJavaType a = new AviatorJavaType("true");
        a.div(BaseAviatorNumber.valueOf(3), createEnvWith(null, null));
    }
    ...
    public void modJavaBooleanWithNumber() {
        AviatorJavaType a = new AviatorJavaType("true");
        a.mod(BaseAviatorNumber.valueOf(3), createEnvWith(null, null));
    }
    ...
    public void compareWithAviatorType() {
        ...
        BaseAviatorNumber number = BaseAviatorNumber.valueOf(3.4);
    ...
    public void testCompareDate() {
        ...
        try {
            new AviatorJavaType("date").compare(BaseAviatorNumber.valueOf(191), env);
            Assert.fail();
        } catch (ExpressionRuntimeException e) {
