...
public class GrammarUnitTest {
    ...
    public void testIntegralIntoDecimal() {
        ...
        assertEquals(Double.valueOf(1.5D), Double.valueOf(((BigDecimal) AviatorEvaluator.execute("3/2")).doubleValue()));
    ...
    public void testArrayIndexAccessWithMethod() {
        assertEquals("a", AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[0]"));
        assertEquals("b", AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[1]"));
        assertEquals("c", AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[2]"));
        assertEquals("d", AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[3]"));
        try {
            AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[4]");
            fail();
        } catch (ExpressionRuntimeException e) {

        }

        assertEquals("a", AviatorEvaluator.getInstance().exec("string.split(s,',')[0]", "a,b,c,d"));
        assertEquals("b", AviatorEvaluator.getInstance().exec("string.split(s,',')[1]", "a,b,c,d"));
        assertEquals("c", AviatorEvaluator.getInstance().exec("string.split(s,',')[2]", "a,b,c,d"));
        assertEquals("d", AviatorEvaluator.getInstance().exec("string.split(s,',')[3]", "a,b,c,d"));
    }
    ...
    public void testIllegalArrayIndexAccessWithMethod1() {
        AviatorEvaluator.getInstance().exec("string.split('a,b,c,d',',')[0");
    }
    ...
    public void testStatement() {
        ...
        assertEquals(4, AviatorEvaluator.getInstance().exec("5;1+2;a", 4));
        assertEquals(4, AviatorEvaluator.getInstance().exec("(3+a)*4;1+2;println(b);a", 4, 5));
    ...
    public void testScientificNotationBiggerSmaller() {
        ...
        assertEquals(4E81 / 3E9, AviatorEvaluator.getInstance().exec("a/3E9", 4E81));
        assertEquals(1E9 / 2E101, AviatorEvaluator.getInstance().exec("1E9/b", 2E101));
    }
