 ...
 * @author dennis
 */
public abstract class BaseClassExpression extends BaseExpression {
    ...
    public BaseClassExpression(AviatorEvaluatorInstance instance, List<String> varNames) {
        super(instance, varNames);
    }

    public BaseLambdaFunction newLambda(Env env, String name) {
