...
public class SeqPredicateFunction extends AbstractFunction {
    ...
    private final BaseAviatorObject value;
    private final BaseAviatorObject propertyName;

    public SeqPredicateFunction(String name, OperatorType opType, BaseAviatorObject value) {
        this(name, opType, value, null);
    }

    public SeqPredicateFunction(String name, OperatorType opType, BaseAviatorObject value,
                                BaseAviatorObject propertyName) {
        this.name = name;
        this.opType = opType;
        this.value = value;
