...
public class LambdaGenerator implements CodeGenerator {
    ...
    private void makeConstructor() {
        {
            ...
            this.mv.visitMethodInsn(INVOKESPECIAL,
                    "com/googlecode/aviator/runtime/function/BaseLambdaFunction", "<init>",
                    "(Ljava/util/List;Lcom/googlecode/aviator/Expression;Lcom/googlecode/aviator/utils/Env;)V");
    ...
    public void compileCallMethod() {
        ...
        if (argsNumber < AviatorConstants.NUMBER20) {
            StringBuilder argsDescSb = new StringBuilder();
            for (int i = 0; i < argsNumber; i++) {
                argsDescSb.append("Lcom/googlecode/aviator/runtime/type/BaseAviatorObject;");
            }
            String argsDec = argsDescSb.toString();

            this.mv = this.classWriter.visitMethod(ACC_PUBLIC + +ACC_FINAL, "call",
                    "(Ljava/util/Map;" + argsDec + ")Lcom/googlecode/aviator/runtime/type/BaseAviatorObject;",
                    "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;" + argsDec
                            + ")Lcom/googlecode/aviator/runtime/type/BaseAviatorObject;",
                    null);
            this.mv.visitCode();
            ...
            this.mv.visitTypeInsn(Opcodes.ANEWARRAY, "com/googlecode/aviator/runtime/type/BaseAviatorObject");
            ...
            this.mv.visitMethodInsn(INVOKEVIRTUAL,
                    "com/googlecode/aviator/runtime/function/BaseLambdaFunction", "newEnv",
                    "(Ljava/util/Map;[Lcom/googlecode/aviator/runtime/type/BaseAviatorObject;)Ljava/util/Map;");
            ...
            this.mv.visitMethodInsn(INVOKESTATIC,
                    ...
                    "(Ljava/lang/Object;)Lcom/googlecode/aviator/runtime/type/BaseAviatorObject;");
            this.mv.visitInsn(ARETURN);
    ...
    private void visitClass() {
        this.classWriter.visit(this.instance.getBytecodeVersion(), ACC_PUBLIC + ACC_SUPER,
                this.className, null, "com/googlecode/aviator/runtime/function/BaseLambdaFunction", null);
    }
    ...
    public LambdaFunctionBootstrap getLmabdaBootstrap() {
        ...
        try {
            ...
            if (ClassDefiner.isJdk7()) {
                ...
                defineClass =
                        ClassDefiner.defineClass(this.className, BaseLambdaFunction.class, bytes, this.classLoader);
            }
