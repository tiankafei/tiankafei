package org.tiankafei.ui.design.example.datetime;
...
public class DateChooserButton extends JButton {
    ...
    private static final long serialVersionUID = 8767427234647510950L;
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        private static final long serialVersionUID = -9004926233375427439L;
        /**
         * 默认【最小】显示年份
         */
        int startYear = 1980;
...
//        Color rbBtFontColor = Color.red; // RoundBox按钮文字色
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            Calendar c = getCalendar();
            if (TiankafeiDesignerConstants.HOUR.equals(source.getName())) {
                c.set(Calendar.HOUR_OF_DAY, getSelectedHour());
                setDate(c.getTime());
                return;
            }
            if (TiankafeiDesignerConstants.MINUTE.equals(source.getName())) {
                c.set(Calendar.MINUTE, getSelectedMinite());
                setDate(c.getTime());
                return;
            }
            if (TiankafeiDesignerConstants.SECOND.equals(source.getName())) {
            ...
            if (TiankafeiDesignerConstants.YEAR.equals(source.getName())) {
                c.set(Calendar.YEAR, getSelectedYear());
            } else if (TiankafeiDesignerConstants.MONTH.equals(source.getName())) {
    ...
    public static void main(String[] args) {
        ...
        mainFrame.add(new DateChooserButton(), BorderLayout.CENTER);
