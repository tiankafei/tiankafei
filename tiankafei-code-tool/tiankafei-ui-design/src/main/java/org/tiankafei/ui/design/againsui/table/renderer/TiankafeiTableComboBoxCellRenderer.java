...
import org.tiankafei.ui.design.againsui.table.TiankafeiTableComboBoxRendererUtil;
 ...
 * @author tiankafei
 */
public class TiankafeiTableComboBoxCellRenderer extends TkfComboBox<Object> implements TableCellRenderer {
     ...
     */
    public TiankafeiTableComboBoxCellRenderer(TkfTable tkfTable) {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        AbstractTiankafeiTableRendererUtil abstractTiankafeiTableRendererUtil = new TiankafeiTableComboBoxRendererUtil();
        //当前表格列对象
