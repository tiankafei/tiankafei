 ...
 * @author tiankafei
 */
public class TkfScrollPane extends JScrollPane {
     ...
     */
    public TkfScrollPane(Component view) {
        super(view);
        tiankafeiModelUiVO = new TiankafeiModelUiVO();
    }
     ...
     */
    public TkfScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
