 ...
 * @author 甜咖啡
 */
public class TiankafeiQuestionInputTextNote extends AbstractTiankafeiReportNote {
    ...
    public void readXML(Element element) {
        ...
        for (int index = 0, length = nodeList.getLength(); index < length; index++) {
            ...
            if (node instanceof Element) {
                ...
                if ("TiankafeiQuestionInputTextNote".equals(tagName)) {
    ...
    public void writeXML(PrintWriter printWriter) {
        ...
        buffer.append("<TiankafeiQuestionInputTextNote ");
        buffer.append(" />");
