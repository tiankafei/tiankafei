 ...
 * @author 甜咖啡
 */
public class TiankafeiQuestionOptionCheckNote extends AbstractTiankafeiReportNote {
    ...
    public void readXML(Element element) {
        ...
        for (int index = 0, length = nodeList.getLength(); index < length; index++) {
            ...
            if (node instanceof Element) {
                ...
                if ("TiankafeiQuestionOptionCheckNote".equals(tagName)) {
    ...
    public void writeXML(PrintWriter printWriter) {
        ...
        buffer.append("<TiankafeiQuestionOptionCheckNote ");
        buffer.append(" />");
