...
public class SecurityAspect1 {
    ...
    @Before("org.tiankafei.springdemo.util.LogUtil7.myPoint()")
    ...
    @AfterReturning(value = "org.tiankafei.springdemo.util.LogUtil7.myPoint()",returning = "result")
    ...
    @AfterThrowing(value = "org.tiankafei.springdemo.util.LogUtil7.myPoint()",throwing = "exception")
    public static void logException(JoinPoint joinPoint,Exception exception){
        String name = joinPoint.getSignature().getName();
        System.out.println("Security:"+name+"方法出现异常："+exception.getMessage());
    }

    @After("org.tiankafei.springdemo.util.LogUtil7.myPoint()")
