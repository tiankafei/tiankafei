...
public class SecurityAspect1 {
    ...
    @Before("cn.tiankafei.spring.util.LogUtil7.myPoint()")
    ...
    @AfterReturning(value = "cn.tiankafei.spring.util.LogUtil7.myPoint()",returning = "result")
    ...
    @AfterThrowing(value = "cn.tiankafei.spring.util.LogUtil7.myPoint()",throwing = "exception")
    public static void logException(JoinPoint joinPoint,Exception exception){
        String name = joinPoint.getSignature().getName();
        System.out.println("Security:"+name+"方法出现异常："+exception.getMessage());
    }

    @After("cn.tiankafei.spring.util.LogUtil7.myPoint()")
