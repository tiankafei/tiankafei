...
public class LogUtil2 {
     ...
     */
    @Before("execution( public int cn.tiankafei.spring.inter.impl.MyCalculator3.*(int,int))")
...
//        System.out.println(method.getName()+"方法开始执行，参数是："+ Arrays.asList(objects));
    ...
    @AfterReturning("execution( public int cn.tiankafei.spring.inter.impl.MyCalculator3.*(int,int))")
...
//        System.out.println(method.getName()+"方法执行结束，结果是："+ Arrays.asList(objects));
    ...
    @AfterThrowing("execution( public int cn.tiankafei.spring.inter.impl.MyCalculator3.*(int,int))")
    public static void logException(){
//        System.out.println(method.getName()+"方法出现异常："+ e.getMessage());
        System.out.println("方法出现异常：");
    }

    @After("execution( public int cn.tiankafei.spring.inter.impl.MyCalculator3.*(int,int))")
